          ...
          {isSidebarOpen && (
            <div className="w-1/5 bg-gray-200">
              ...
              <div className="flex flex-col h-full p-4">
                ...
                <div className="flex flex-col h-full p-4 ">
                <button className="py-2 mb-2 bg-white hover:bg-gray-100 text-gray-600 text-lg font-medium rounded-md mb-4">History</button>
                <button className="py-2 mb-2 bg-white hover:bg-gray-100 text-gray-600 text-lg font-medium rounded-md mb-4">Reminder</button>
                <button className="py-2 mb-2 bg-white hover:bg-gray-100 text-gray-600 text-lg font-medium rounded-md mb-4">Beneficiary Stories</button>
                <button className="py-2 mb-2 bg-white hover:bg-gray-100 text-gray-600 text-lg font-medium rounded-md ">My Account</button>
                <button className="py-2 mb-2 mt-auto  bg-white hover:bg-gray-100 text-gray-600 text-lg font-medium rounded-md">Logout</button>
              </div>
            </div>
            </div>
          )}
